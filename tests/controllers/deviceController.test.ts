...
describe('Device Controller', () => {
    ...
    describe('addDevice', () => {
        ...
        it('should successfully add a device', async () => {
            ...
            expect(mockResponse.json).toHaveBeenCalledWith({ message: 'Пристрій додано.' });
        });

        it('should handle errors when adding a device', async () => {
            (Device.prototype.save as jest.Mock).mockRejectedValue(new Error('DB Error'));
    ...
    describe('getDevicesByOwnerId', () => {
        ...
        it('should successfully get devices by owner id', async () => {
            ...
            await getDevicesByOwnerId(mockRequest as RequestWithUser, mockResponse as Response);
    ...
    describe('deleteDevice', () => {
        ...
        it('should handle device not found', async () => {
            ...
            await deleteDevice(mockRequest as RequestWithUser, mockResponse as Response);
