...
describe('Payment Card Controller', () => {
    ...
    describe('addPaymentCard', () => {
        ...
        it('should handle errors when adding a payment card', async () => {
            (PaymentCard.prototype.save as jest.Mock).mockRejectedValue(new Error('DB Error'));
    ...
    describe('getPaymentCardsByOwnerId', () => {
        ...
        it('should successfully get payment cards by owner id', async () => {
            ...
            await getPaymentCardsByOwnerId(mockRequest as RequestWithUser, mockResponse as Response);
    ...
    describe('deletePaymentCard', () => {
        ...
        it('should handle errors during deletion', async () => {
            (PaymentCard.findById as jest.Mock).mockRejectedValue(new Error('DB Error'));
