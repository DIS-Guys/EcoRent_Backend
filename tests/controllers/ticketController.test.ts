...
import { createTicket, getTicketById, getAllTickets, deleteTicket } from '../../src/controllers/ticketController';
...
describe('Ticket Controller Tests', () => {
    ...
    describe('deleteTicket', () => {
        ...
        it('should successfully delete ticket', async () => {
            ...
            const response = await request(app)
                .delete(`/tickets/${mockId.toString()}`);
